...
cd /usr/bin
wget https://raw.githubusercontent.com/kapal-api-cup/Script-vpn/main/bot/bot.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip
clear
wget https://raw.githubusercontent.com/kapal-api-cup/Script-vpn/main/bot/kyt.zip
unzip kyt.zip
